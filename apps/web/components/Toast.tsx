  ...
  return (
    <div className="fixed top-4 right-4 z-50 space-y-3 pointer-events-none max-w-md">
      {toasts.map((toast) => (
        <div
          key={toast.id}
          className={`${toastStyles[toast.type]} border rounded-lg p-4 flex items-start gap-3 shadow-lg pointer-events-auto animate-slide-up transition-all duration-300`}
        >
