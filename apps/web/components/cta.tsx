    ...
    <section className="relative w-full py-14 px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8 mb-6">
          <button className="px-8 py-3 rounded-full font-semibold text-rose bg-white hover:shadow-lg hover:scale-105 transition-all">
            Bắt đầu miễn phí ngay →
          </button>
          <button className="px-8 py-3 rounded-full font-semibold text-white border-2 border-white hover:bg-white/10 transition-all">
            Xem mẫu thiệp
          </button>
        </div>
