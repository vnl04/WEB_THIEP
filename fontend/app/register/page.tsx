...
import { createCardFromTemplate, persistAuth } from '@/lib/auth'
...
function RegisterForm() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-rose/10 to-white flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-serif font-bold text-dark">Bắt đầu miễn phí</h1>
          <p className="text-gray-600 mt-2">
            {templateId
              ? 'Tạo tài khoản để dùng mẫu thiệp đã chọn'
              : 'Tạo thiệp cưới đẹp chỉ trong vài phút'}
          </p>
        </div>
        ...
        <p className="text-center text-gray-600 mt-6">
          Đã có tài khoản?{' '}
          <Link href={ROUTES.login} className="text-rose font-medium hover:underline">
            Đăng nhập
          </Link>
        </p>
      </div>
