...
export default function Pricing() {
  ...
  return (
    <section id="bang-gia" className="w-full py-14 px-4 bg-gradient-to-b from-white to-gray-light scroll-mt-20">
            ...
            >
              ...
              <div className="p-6">
                ...
                <Link
                  ...
                  className={`w-full py-3 rounded-full font-semibold mb-7 transition-all text-sm text-center block ${
                    plan.highlighted
                      ? 'btn-primary'
